...
data$Vaccinated_count = as.numeric(gsub(",","",as.character(data$Vaccinated_count)))
data$Vaccinated.percent = as.numeric(gsub("%","",as.character(data$Vaccinated.percent)))/100
...
server <- function(input, output) {
    ...
    output$map <- renderPlot({
        var <- switch(input$var, 
                      ...
                      "Percentage of retured Nurse" = data_map$percent_retired,
        ...
        label = switch(input$var, 
                       ...
                       "Percentage of retured Nurse" = "Percentage",
